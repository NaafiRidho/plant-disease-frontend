    ...
    <div style={{ backgroundColor: '#020b14', color: '#f0fdf4', minHeight: '100vh', paddingTop: '100px', paddingBottom: '4rem', fontFamily: 'sans-serif' }}>
      ...
      <div className="container" style={{ marginBottom: '2.5rem' }}>
        <div className="header-card">
          ...
          {/* FOKUS VISUAL: Menggunakan gambar dari folder asset kentang */}
        ...
        <div style={{ backgroundColor: 'rgba(6, 20, 36, 0.6)', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '24px', padding: '2.5rem' }}>
          ...
          <div className="info-grid">
            ...
            <div>
              ...
              <div style={{ fontSize: '0.8rem', color: 'rgba(240,253,244,0.5)' }}>Genus: Solanum<br />Spesies: tuberosum</div>
            </div>
        ...
        <div style={{ backgroundColor: 'rgba(6, 20, 36, 0.6)', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '24px', padding: '2.5rem' }}>
          ...
          <div className="diag-grid">
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              ...
              <div>
                <div style={{ fontSize: '0.9rem', fontWeight: 700, color: '#f43f5e', marginBottom: '2px' }}>Late Blight</div>
                <div style={{ fontSize: '0.75rem', color: 'rgba(240,253,244,0.5)', lineHeight: 1.4 }}>Bercak basah yang menyebar cepat, berubah menjadi coklat keunguan.</div>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              ...
              <div>
                <div style={{ fontSize: '0.9rem', fontWeight: 700, color: '#a855f7', marginBottom: '2px' }}>Blackleg</div>
                <div style={{ fontSize: '0.75rem', color: 'rgba(240,253,244,0.5)', lineHeight: 1.4 }}>Pembusukan batang bagian bawah yang berwarna hitam dan berlendir.</div>
              </div>
            </div>
          </div>
        </div>
